...
const ResignationForm = () => {
    ...
    const [resiginationReason, setResiginationReason] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        console.log('Resigination Reason:', resiginationReason);
    };
            ...
            <Grid item xs={8}>
                <Paper elevation={3} style={{ padding: 20 }}>
                    <Typography variant="h5" align="center" gutterBottom>
                        EMPLOYEE RESIGINATION APPLICATION FORM
                    </Typography>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    label="Resigination Reason"
                                    variant="outlined"
                                    fullWidth
                                    multiline
                                    rows={4}
                                    value={resiginationReason}
                                    onChange={(e) => setResiginationReason(e.target.value)}
                                />
                            </Grid>
                            <Grid item xs={12}>
